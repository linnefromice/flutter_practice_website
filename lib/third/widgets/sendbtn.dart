            ...
            child: Center(
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Image.network(
                    "assets/third/sent.png",
                    color: Colors.white,
                    width: ResponsiveLayout.isSmallScreen(context) ? 12 : (ResponsiveLayout.isMediumScreen(context) ? 12 : 20),
                    height: ResponsiveLayout.isSmallScreen(context) ? 12 : (ResponsiveLayout.isMediumScreen(context) ? 12 : 20),
                  )
                ],
              ),
            ),
